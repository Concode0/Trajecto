...
#define BLE_SVC_UUID               0x180
#define BLE_CHR_UUID               0x181
...
// Write data to ESP32 defined as callback
...
// Read data from ESP32 defined as callback
...
static const struct ble_gatt_svc_def gatt_svcs[] = {
    {.type = BLE_GATT_SVC_TYPE_PRIMARY,
     ...
     .characteristics = (struct ble_gatt_chr_def[]){
         {.uuid = BLE_UUID16_DECLARE(BLE_CHR_UUID),
...
void app_main(void)
{
    ...
    nimble_port_init();                        // 2 - Initialize the host stack
    ble_svc_gap_device_name_set("Nimble");     // 3 - Initialize Nimble configuration - server name
